...
public class OrderDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sql = "create table if not exists " + TABLE_item + " (taskId integer primary key, type text, describe text , publishTime text, getTime text, getLocation text,sendTime text , sendLocation text , pickupCode  text , price Real , PorA integer)";
